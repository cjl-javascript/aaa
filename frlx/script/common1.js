...
$(function () {
    ...
    $("#btncode").click(function () {
        ...
        $.ajax({
            ...
            //  url: "https://m.liuxuejp.com.cn/Api/LSendMsg.ashx?mobile=" + mobile,
...
function AjaxRegister(name, mobile, email, seladdr, ID, adname, act, calladdr, k, key360, m) {
    ...
    $.ajax({
        url: "/Api/actionResult.asp?action=register",
        // url: "https://m.liuxuejp.com.cn/Api/actionResult_PV.ashx?action=register",
        dataType: "text",
        type: "post",
