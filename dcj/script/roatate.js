;(function(win){
    ...
    var rotateEx = function(allParent,parent,faceClass,backClass,Proportion,isInit){
        ...
        this.errorMsg = -1;
        this.addXSpeed = 3;
        this.proportion = Proportion||0.5;//元素之间的两个间隔和元素最左边的两个的间隔比例
        this.type = "allFace";
        this.amtType = "f";
        this.amtInt = 0;
        this.faceClassInfo = {
    ...
    rotateEx.prototype = {
        ...
        initPositionArr:function(){
            ...
            $.each(this.parentEles,function(i,item){
                var x = 0,
                    y = 0,
                    w = this.offsetWidth-50,
                    h = this.offsetHeight+20;

                // var jg1 = (apW - w*4 )* THIS.proportion/(THIS.proportion+1)/2,
                //     jg2 = (apW - w*4)* 1/(THIS.proportion+1)/2,
                //     jg3 = (apH - h*4.3)/2;
                ...
                if(i<=2){
                    ...
                    THIS.positionArr.push({
                        ...
                        // translate3DStr:-53.5+"px,"+(-66.3)+"px,"+"0"
                    });
                }else if(i>2&&i<=4){
                    if(i==3){
