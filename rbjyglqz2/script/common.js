...
$(function () {
    ...
    $("#btncode").click(function () {
        ...
        time(this);
        $.ajax({
            url: "/Api/XsjVisaSendMsg.ashx?mobile=" + mobile,
            type: "get",
            dataType: "text",
...
function Register(nameID, mobileID) {
    ...
    AjaxRegister(username, mobile, '', '', ID, adname, act, '', kw, key360, '移民');
...
function AjaxRegister(name, mobile, email, seladdr, ID, adname, act, calladdr, k, key360, m) {
    ...
    $.ajax({
        url: "/Api/XsjVisaResult.ashx?action=register",
        dataType: "text",
        type: "post",
